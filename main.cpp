...
void on_create(HWND hw) 
{
	...
	CreateWindow("BUTTON", "one", WS_CHILD | WS_VISIBLE, 50, 50, 100, 40, hw, HMENU(id_button1), NULL, NULL);
	CreateWindow("BUTTON", "two", WS_CHILD | WS_VISIBLE, 50, 100, 100, 40, hw, HMENU(id_button2), NULL, NULL);
